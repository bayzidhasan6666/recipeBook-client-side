...
const AboutUs = () => {
  ...
  return (
    <div data-aos="fade-up" className="bg-gray-900 text-white ">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          ...
          <p className="mt-2 text-3xl font-serif leading-8 font-extrabold tracking-tight text-red-400 text-center sm:text-4xl">
            ...
            <Typewriter
              options={{
                delay: 70,
                strings: [`We are passionate about good food`],
                autoStart: true,
                loop: true,
                pauseFor: 2000,
              }}
        ...
        <div className="mt-12 grid gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
          <div
            data-aos="fade-right"
            className="border border-yellow-400 rounded-lg shadow-lg overflow-hidden"
          >
            <img
              src={
          ...
          <Link to={`/leaflet`}>
            ...
            <div
              data-aos="fade-left"
              className="border-teal-400 border rounded-lg shadow-lg overflow-hidden"
            >
              <img
        ...
        {/* Map section */}{' '}
        <div data-aos="fade-up" className="relative h-96 my-10">
          <Leaflet />
